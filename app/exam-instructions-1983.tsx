...
const instructions = [
  ...
  ['10', 'مديري مراكز الامتحانات العامة'],
  ['11', 'أعضاء لجان الفحص والتدقيق'],
  ['12', 'مديري مراكز الفحص'],
  ['13', 'الخاصة باللجان الطبية'],
  ['14', 'اشتراك الخارجيين في الامتحانات العامة'],
  ['15', 'المديريات العامة للتربية'],
  ['16', 'تنظيم مراكز الامتحانات العامة'],
  ['17', 'بشأن تنظيم الوثائق المدرسية'],
  ['18', 'الخاصة بتنظيم الوثائق وتصديقها'],
  ['19', 'ترجمة وتصديق الوثائق'],
  ['20', 'أسس متابعة نتائج الامتحانات العامة'],
  ['21', 'تطوير أساليب التقويم'],
  ['22', 'الخاصة بمتابعة المستويات العلمية'],
  ['23', 'الخاصة بإعداد الطلاب الناجحين ونسبهم في الامتحانات المدرسية'],
  ['24', 'استخدام البطاقة المدرسية'],
];
    ...
    <View style={[styles.page, { backgroundColor: c.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 15, paddingBottom: insets.bottom + 35 }}>
        <View style={[styles.notice, { backgroundColor: c.secondary }]}>
          ...
          <Text style={[styles.noticeText, { color: c.secondaryForeground }]}>هذه نافذة مرجعية لمجموعة التعليمات الامتحانية لسنة 1983. أدرجت أرقام التعليمات وعناوينها بحسب الفهارس والمراجع المتاحة، وسنربط النصوص وملفات PDF الموثقة لاحقًا دون اختلاق نصوص أو أرقام مواد.</Text>
        </View>
        ...
        <View style={[styles.sourceCard, { backgroundColor: c.secondary }]}>
          ...
          <Text style={[styles.sourceText, { color: c.secondaryForeground }]}>المراجع المتاحة توثق مجموعة الأنظمة والتعليمات الخاصة بالامتحانات والشهادات الصادرة عن وزارة التربية سنة 1983، وتشير إلى تعليمات تمتد إلى الرقم 24. سيتم اعتماد النسخة الأصلية الموثقة عند إدخال ملفات PDF.</Text>
        </View>
      </ScrollView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontFamily: 'Inter_400Regular', fontSize: 12, marginTop: 3, textAlign: 'right', lineHeight: 16 },
  ...
  noticeText: { flex: 1, fontFamily: 'Inter_500Medium', fontSize: 12, lineHeight: 18, textAlign: 'right' },
  ...
  numberText: { fontFamily: 'Inter_700Bold', fontSize: 18 },
  textBox: { flex: 1, alignItems: 'flex-end' },
  label: { fontFamily: 'Inter_500Medium', fontSize: 11, textAlign: 'right' },
  cardTitle: { fontFamily: 'Inter_700Bold', fontSize: 15, lineHeight: 20, textAlign: 'right', marginTop: 3 },
  sourceCard: { marginTop: 5, borderRadius: 15, padding: 13, flexDirection: 'row-reverse', alignItems: 'flex-start', gap: 9 },
  sourceText: { flex: 1, fontFamily: 'Inter_500Medium', fontSize: 12, lineHeight: 18, textAlign: 'right' },
});
