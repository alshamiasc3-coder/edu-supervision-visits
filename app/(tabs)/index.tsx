...
const styles = StyleSheet.create({
  ...
  topText: { flex: 1 },
  eyebrow: { fontSize: 14, fontFamily: 'Inter_600SemiBold', textAlign: 'right' },
  ...
  heroText: { flex: 1 },
  heroKicker: { color: '#D5EEF0', fontSize: 14, fontFamily: 'Inter_600SemiBold', textAlign: 'right', marginBottom: 9 },
  heroTitle: { color: '#FFFFFF', fontSize: 20, lineHeight: 30, fontFamily: 'Inter_700Bold', textAlign: 'right' },
  heroSub: { color: '#D5EEF0', fontSize: 13, lineHeight: 20, fontFamily: 'Inter_400Regular', textAlign: 'right', marginTop: 9 },
  ...
  metricValue: { fontSize: 23, fontFamily: 'Inter_700Bold', marginTop: 4 },
  metricLabel: { fontSize: 12, fontFamily: 'Inter_500Medium', marginTop: 3 },
  ...
  quickText: { fontFamily: 'Inter_600SemiBold', marginTop: 8, textAlign: 'center', fontSize: 14 },
  ...
  dateDay: { fontFamily: 'Inter_700Bold', fontSize: 19 },
  dateMonth: { fontFamily: 'Inter_500Medium', fontSize: 11 },
  visitInfo: { flex: 1, minWidth: 0 },
  rowTitle: { fontFamily: 'Inter_600SemiBold', fontSize: 15, textAlign: 'right' },
  rowSub: { fontFamily: 'Inter_400Regular', fontSize: 12, textAlign: 'right', marginTop: 4 },
  ...
  emptyVisitsTitle: { fontFamily: 'Inter_700Bold', fontSize: 16, marginTop: 10 },
  emptyVisitsText: { fontFamily: 'Inter_400Regular', fontSize: 12, textAlign: 'center', marginTop: 4 },
  ...
  todayText: { flex: 1 },
  todayTitle: { fontFamily: 'Inter_700Bold', fontSize: 15, textAlign: 'right' },
  todaySub: { fontFamily: 'Inter_400Regular', fontSize: 12, textAlign: 'right', marginTop: 3 },
  todayLink: { fontFamily: 'Inter_700Bold', fontSize: 13 },
  offline: { marginTop: 17, borderRadius: 14, padding: 12, flexDirection: 'row-reverse', alignItems: 'center', gap: 8 },
  offlineText: { fontFamily: 'Inter_500Medium', fontSize: 12, flex: 1, textAlign: 'right' },
  credit: { textAlign: 'center', fontSize: 11, fontFamily: 'Inter_400Regular', marginTop: 20 },
});