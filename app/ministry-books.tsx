...
function BookCard({ book, c, categoryBackground, onAttachmentPress, onPdfPress, onEdit, onDelete }: any) {
  return <View style={[styles.bookCard, { backgroundColor: c.card, borderColor: c.border }]}>
    ...
    <View style={styles.bookInfo}><View style={styles.bookTopRow}><View style={[styles.categoryBadge, { backgroundColor: categoryBackground }]}><Text style={[styles.categoryText, { color: c.primary }]}>{book.category}</Text></View><Text style={[styles.bookTitle, { color: c.foreground }]} numberOfLines={2}>{book.title}</Text></View>
      ...
      <View style={styles.bookActions}><Pressable onPress={onDelete} style={[styles.actionButton, { backgroundColor: '#FDE7E7' }]}><Feather name="trash-2" size={16} color="#C62828" /><Text style={{ color: '#C62828', fontFamily: 'Inter_600SemiBold', fontSize: 13 }}>حذف</Text></Pressable><Pressable onPress={onEdit} style={[styles.actionButton, { backgroundColor: c.secondary }]}><Feather name="edit-2" size={16} color={c.primary} /><Text style={{ color: c.primary, fontFamily: 'Inter_600SemiBold', fontSize: 13 }}>تعديل</Text></Pressable><Pressable onPress={onAttachmentPress} style={[styles.actionButton, { backgroundColor: c.secondary }]}><Feather name={book.pdfUri && !book.imageUri ? 'file-text' : 'image'} size={16} color={c.primary} /><Text style={{ color: c.primary, fontFamily: 'Inter_600SemiBold', fontSize: 13 }}>{book.pdfUri && !book.imageUri ? 'PDF' : 'عرض'}</Text></Pressable></View>
    </View>
  </View>;
}
...
const styles = StyleSheet.create({
  container:{flex:1}, content:{paddingHorizontal:16,paddingTop:18}, header:{flexDirection:'row-reverse',alignItems:'center',justifyContent:'space-between',marginBottom:16}, headerCenter:{flex:1,alignItems:'center'}, headerButton:{width:44,height:44,borderRadius:14,borderWidth:1,alignItems:'center',justifyContent:'center'}, addButton:{width:44,height:44,borderRadius:14,alignItems:'center',justifyContent:'center'}, eyebrow:{fontSize: 13,fontFamily:'Inter_600SemiBold',textAlign:'center'}, headerTitle:{fontSize: 22,fontFamily:'Inter_700Bold',textAlign:'center',marginTop:3}, headerSub:{fontSize: 12,fontFamily:'Inter_400Regular',textAlign:'center',marginTop:3}, infoCard:{borderRadius:20,padding:17,flexDirection:'row-reverse',alignItems:'center',gap:13,marginBottom:12}, infoIcon:{width:53,height:53,borderRadius:17,alignItems:'center',justifyContent:'center'}, infoTitle:{color:'#FFFFFF',fontSize: 18,fontFamily:'Inter_700Bold',textAlign:'right',marginBottom:5}, infoText:{color:'#B7D9D4',fontSize: 13,lineHeight:18,fontFamily:'Inter_400Regular',textAlign:'right'}, quickAddButton:{minHeight:53,borderRadius:16,flexDirection:'row-reverse',alignItems:'center',justifyContent:'center',gap:8,marginBottom:14}, quickAddText:{color:'#FFFFFF',fontSize: 15,fontFamily:'Inter_700Bold'}, searchBox:{minHeight:49,borderRadius:15,borderWidth:1,paddingHorizontal:13,flexDirection:'row-reverse',alignItems:'center',gap:9}, searchInput:{flex:1,fontFamily:'Inter_400Regular',fontSize: 14,textAlign:'right',paddingVertical:9}, sectionTitle:{fontSize: 16,fontFamily:'Inter_700Bold',textAlign:'right',marginTop:19,marginBottom:9}, categories:{gap:7,paddingBottom:2}, categoryButton:{paddingHorizontal:13,paddingVertical:9,borderRadius:12,borderWidth:1}, countRow:{flexDirection:'row-reverse',justifyContent:'space-between',alignItems:'center',marginTop:12,marginBottom:10}, countText:{fontSize: 13,fontFamily:'Inter_500Medium'}, bookCard:{borderRadius:18,borderWidth:1,padding:11,flexDirection:'row-reverse',gap:12,marginBottom:10,minHeight:150}, bookImageContainer:{width:112,height:142,borderRadius:13,overflow:'hidden',position:'relative',backgroundColor:'#EEF5F4'}, bookImage:{width:'100%',height:'100%'}, pdfThumb:{width:'100%',height:'100%',alignItems:'center',justifyContent:'center'}, pdfThumbText:{fontFamily:'Inter_700Bold',fontSize: 15,marginTop:5}, imageZoomIcon:{position:'absolute',left:7,bottom:7,width:27,height:27,borderRadius:9,backgroundColor:'rgba(0,0,0,0.55)',alignItems:'center',justifyContent:'center'}, bookInfo:{flex:1,minWidth:0}, bookTopRow:{flexDirection:'row-reverse',alignItems:'flex-start',gap:7}, bookTitle:{flex:1,fontSize: 16,lineHeight:20,fontFamily:'Inter_700Bold',textAlign:'right'}, categoryBadge:{borderRadius:8,paddingHorizontal:7,paddingVertical:5}, categoryText:{fontSize: 11,fontFamily:'Inter_600SemiBold'}, bookNumber:{fontSize: 12,fontFamily:'Inter_500Medium',textAlign:'right',marginTop:8}, bookDate:{fontSize: 12,fontFamily:'Inter_400Regular',textAlign:'right',marginTop:8}, pdfLink:{fontSize: 12,fontFamily:'Inter_600SemiBold',textAlign:'right',marginTop:6}, bookNotes:{fontSize: 12,lineHeight:16,fontFamily:'Inter_400Regular',textAlign:'right',marginTop:5}, bookActions:{flexDirection:'row-reverse',justifyContent:'flex-start',flexWrap:'wrap',gap:7,marginTop:9}, actionButton:{minWidth:60,borderRadius:9,paddingHorizontal:8,paddingVertical:7,flexDirection:'row-reverse',alignItems:'center',justifyContent:'center',gap:5}, empty:{borderRadius:20,borderWidth:1,padding:30,alignItems:'center',justifyContent:'center',marginTop:7}, emptyIcon:{width:65,height:65,borderRadius:21,alignItems:'center',justifyContent:'center'}, emptyTitle:{fontSize: 18,fontFamily:'Inter_700Bold',marginTop:13}, emptyText:{fontSize: 13,fontFamily:'Inter_400Regular',textAlign:'center',lineHeight:18,marginTop:5}, emptyButton:{marginTop:16,borderRadius:12,paddingHorizontal:17,paddingVertical:10,flexDirection:'row-reverse',alignItems:'center',gap:6}, modalOverlay:{flex:1,backgroundColor:'rgba(0,0,0,0.45)',justifyContent:'flex-end'}, modal:{maxHeight:'94%',borderTopLeftRadius:25,borderTopRightRadius:25,paddingHorizontal:17,paddingTop:15}, modalHeader:{flexDirection:'row-reverse',alignItems:'center',justifyContent:'space-between',marginBottom:10}, modalTitle:{fontSize: 20,fontFamily:'Inter_700Bold'}, label:{fontSize: 14,fontFamily:'Inter_600SemiBold',textAlign:'right',marginTop:14,marginBottom:7}, input:{minHeight:48,borderRadius:13,borderWidth:1,paddingHorizontal:12,fontFamily:'Inter_400Regular',fontSize: 14,textAlign:'right'}, notesInput:{minHeight:105,borderRadius:13,borderWidth:1,paddingHorizontal:12,paddingTop:12,fontFamily:'Inter_400Regular',fontSize: 14,textAlign:'right'}, imagePicker:{height:190,borderRadius:17,borderWidth:1,borderStyle:'dashed',alignItems:'center',justifyContent:'center',overflow:'hidden'}, previewImage:{width:'100%',height:'100%'}, uploadIcon:{width:60,height:60,borderRadius:20,alignItems:'center',justifyContent:'center'}, uploadTitle:{fontSize: 15,fontFamily:'Inter_700Bold',marginTop:10}, uploadSub:{fontSize: 12,fontFamily:'Inter_400Regular',marginTop:4}, attachmentActions:{flexDirection:'row-reverse',alignItems:'center',gap:7,marginTop:7}, changeImageButton:{borderWidth:1,borderRadius:9,paddingHorizontal:10,paddingVertical:7,flexDirection:'row-reverse',alignItems:'center',gap:5}, removeImageButton:{borderWidth:1,borderColor:'#F2B8B8',backgroundColor:'#FDE7E7',borderRadius:9,paddingHorizontal:10,paddingVertical:7,flexDirection:'row-reverse',alignItems:'center',gap:5}, removeImageText:{color:'#C62828',fontFamily:'Inter_600SemiBold',fontSize: 13}, pdfBox:{height:190,borderRadius:17,borderWidth:1,borderStyle:'dashed',alignItems:'center',justifyContent:'center',padding:20}, pdfTitle:{fontSize: 16,fontFamily:'Inter_700Bold',textAlign:'center',marginTop:10}, pdfSub:{fontSize: 12,fontFamily:'Inter_400Regular',marginTop:5}, formCategories:{flexDirection:'row-reverse',flexWrap:'wrap',gap:7}, formCategory:{borderRadius:10,borderWidth:1,paddingHorizontal:11,paddingVertical:9}, saveButton:{minHeight:51,borderRadius:14,marginTop:20,flexDirection:'row-reverse',alignItems:'center',justifyContent:'center',gap:8}, saveText:{color:'#FFFFFF',fontSize: 16,fontFamily:'Inter_700Bold'}, cancelButton:{minHeight:48,borderRadius:14,borderWidth:1,marginTop:9,alignItems:'center',justifyContent:'center'}, previewOverlay:{flex:1,backgroundColor:'rgba(0,0,0,0.94)',alignItems:'center',justifyContent:'center',paddingHorizontal:15}, previewClose:{position:'absolute',top:Platform.OS==='web'?25:55,right:20,width:45,height:45,borderRadius:14,backgroundColor:'rgba(255,255,255,0.15)',alignItems:'center',justifyContent:'center',zIndex:10}, previewContainer:{width:'100%',height:'72%',alignItems:'center',justifyContent:'center'}, fullPreviewImage:{width:'92%',height:'92%'}, previewBottomButton:{position:'absolute',bottom:Platform.OS==='web'?25:45,minWidth:110,minHeight:44,borderRadius:13,paddingHorizontal:17,flexDirection:'row-reverse',alignItems:'center',justifyContent:'center',gap:7,backgroundColor:'rgba(255,255,255,0.15)'}, previewBottomText:{color:'#FFFFFF',fontFamily:'Inter_600SemiBold',fontSize: 15}, pdfPreviewBox:{alignItems:'center',justifyContent:'center',padding:30}, pdfPreviewTitle:{color:'#FFFFFF',fontFamily:'Inter_700Bold',fontSize: 18,textAlign:'center',marginTop:15,maxWidth:320}, openPdfButton:{marginTop:20,minHeight:48,borderRadius:13,paddingHorizontal:18,flexDirection:'row-reverse',alignItems:'center',justifyContent:'center',gap:8,backgroundColor:'rgba(255,255,255,0.15)'}
});
