    ...
    <View style={[styles.page, { backgroundColor: c.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 15, paddingBottom: insets.bottom + 35 }}>
        ...
        <LegislationCard
          ...
          meta={[['الرقم', '6'], ['السنة', '2016'], ['الوقائع العراقية', '4427'], ['تاريخ النشر', '12/12/2016']]}
          source="وزارة العدل – الوقائع العراقية"
        />
        ...
        <LegislationCard
          ...
          meta={[['الرقم', '2'], ['السنة', '1977'], ['الحالة', 'معدل'], ['الموضوع', 'المدارس الثانوية']]}
          source="وزارة التربية والوقائع العراقية"
        />

        <LegislationCard
          c={c}
          category="تعليمات امتحانية"
          title="تعليمات رقم (1) لسنة 1983 بشأن امتحانات نصف السنة والامتحانات النهائية"
          meta={[['الرقم', '1'], ['السنة', '1983'], ['الموضوع', 'الامتحانات المدرسية'], ['الارتباط', 'نظام المدارس الثانوية']]}
          source="وزارة التربية – الأنظمة والتعليمات الامتحانية"
        />
        ...
        <LegislationCard
          ...
          meta={[['الرقم', '18'], ['السنة', '1987'], ['الموضوع', 'الامتحانات العامة'], ['الجهة', 'وزارة التربية']]}
          source="وزارة التربية – الوقائع العراقية"
        />
        ...
        <LegislationCard
          ...
          meta={[['الرقم', '14'], ['السنة', '1991'], ['الحالة', 'معدل'], ['الموضوع', 'انضباط الموظفين']]}
          source="وزارة العدل – الوقائع العراقية"
          pdf={DISCIPLINE_PDF}
        ...
        <LegislationCard
          c={c}
          category="قانون"
          title="قانون العطلات الرسمية رقم (12) لسنة 2024"
          meta={[['الرقم', '12'], ['السنة', '2024'], ['الوقائع العراقية', '4777'], ['تاريخ النشر', '27/05/2024']]}
  ...
  return (
    <View style={[styles.card, { backgroundColor: c.card, borderColor: c.border }]}>
      ...
      <View style={styles.metaGrid}>
        {meta.map(([label, value]: string[], index: number) => (
          <Meta key={`${label}-${index}`} label={label} value={value} c={c} />
        ))}
      </View>
